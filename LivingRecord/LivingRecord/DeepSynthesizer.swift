...
enum CloudSynthesizer {
    ...
    static func synthesize(distilled: String, apiKey: String) async throws -> String {
        ...
        let body: [String: Any] = [
            "model": model,
            "max_tokens": 900,
            "system": "너는 사려 깊은 회고 도우미다. 주어진 한 주의 '주제별 요약'을 보고 흐름·반복·발전을 통찰하고, 무엇을 지속하면 좋을지 따뜻하되 구체적으로 한국어 5~8문장으로 종합하라. 단순 나열 금지.",
